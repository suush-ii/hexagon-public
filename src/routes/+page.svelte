<script lang="ts">
  ...
  let isLoading = false;
	...
	<div class="flex h-screen">
		...
		<div class="relative mx-auto font-bold z-20 flex items-center text-5xl">
			Hexagon
		</div>
				...
				<Card.Content>
						<div class="grid w-full items-center gap-4">
						  <div class="flex flex-col space-y-1.5">
							...
							<Input id="username" disabled={isLoading} placeholder="(3-20 Characters, no spaces)" />
						  </div>
						  <div class="flex flex-col space-y-1.5">
						  ...
						  <div class="flex flex-col space-y-1.5">
							...
							<Select.Root disabled={isLoading}>
							  ...
							  <Select.Content>
								...
								<Select.Item value="nonbinary" label="None"
								>{"None"}</Select.Item
								>
